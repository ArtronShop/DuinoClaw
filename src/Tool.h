...
class Tool {
    public:
        ...
        void addEnumProperty(const char * name, const char * description, DataType_t type, void * enum_values, uint8_t enum_count, bool required) ;
        void addEnumProperty(const char * name, const char * description, const char ** enum_values, uint8_t enum_count, bool required) ;
        void addEnumProperty(const char * name, const char * description, const long * enum_values, uint8_t enum_count, bool required) ;
